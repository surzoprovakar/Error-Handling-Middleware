...
LD_LIBRARY_PATH=. ../ast_server 1 localhost:5081 Addresses1.txt Scn1/Actions1.txt
...
# LD_LIBRARY_PATH=. ../ast_server 1 localhost:5081 Addresses1.txt Scn2/Actions1.txt
...
# LD_LIBRARY_PATH=. ../ast_server 1 localhost:5081 Addresses1.txt Scn3/Actions1.txt


# Without Middleware
# ../server 1 localhost:5081 Addresses1.txt Actions1.txt