...
hue = [196.6, 232.1, 258.6, 283.9, 358.1]
mvr_undo = [168.9, 187.3, 219.6, 227.9, 259.9]
stateRoll = [201.39, 227.4, 271.5, 302.7, 381.69]
...
plt.savefig('FeatureStorm-Memory.pdf', format='pdf', dpi=300, bbox_inches='tight')
