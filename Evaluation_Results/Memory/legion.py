...
hue = [256.3, 278.5, 320.9, 377.4, 409.65]
mvr_undo = [238.4, 251.6, 279.6, 316.1, 337.9]
stateRoll = [265.6, 281.5, 313.6, 390.6, 445.4]
...
plt.savefig('Legion-Memory.pdf', format='pdf', dpi=300, bbox_inches='tight')
