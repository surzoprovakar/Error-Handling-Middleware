...
# Throughput (ops/sec)
hue_throughput = [153.693, 151.289, 140.273, 124.630, 109.537]
mvr_throughput = [165.740, 158.849, 153.112, 142.916, 133]
stateRoll_throughput = [159.933, 142.376, 132.314, 110.460, 93.624]
...
plt.savefig('rKV-Replica5.pdf', format='pdf', dpi=300, bbox_inches='tight')
