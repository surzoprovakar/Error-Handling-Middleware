...
# Throughput (ops/sec)
hue_throughput = [120.693, 117.289, 109.63, 78.460, 62.73]
mvr_throughput = [144.740, 139.849, 129.112, 117.916, 103.69]
stateRoll_throughput = [122.39, 112.6, 97.43, 74.06, 65.22]
...
plt.savefig('rKV-Replica9.pdf', format='pdf', dpi=300, bbox_inches='tight')
