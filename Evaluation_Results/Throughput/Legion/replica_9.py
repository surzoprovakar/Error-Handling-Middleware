...
# Throughput (ops/sec)
hue_throughput = [91.14, 82.14, 71.80, 64.63, 47.71]
mvr_throughput = [116.51, 101.99, 96.93, 87.32, 71.206]
stateRoll_throughput = [102.01, 88.25, 74.21, 47.94, 34.32]
...
plt.savefig('Legion-Replica9.pdf', format='pdf', dpi=300, bbox_inches='tight')
