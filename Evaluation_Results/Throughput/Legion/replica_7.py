...
# Throughput (ops/sec)
hue_throughput = [109.998, 106.37, 99.28, 89.77, 69.68]
mvr_throughput = [129.05, 126.03, 116.57, 103.29, 96.57]
stateRoll_throughput = [100.79, 90.101, 86.65, 71.10, 54.63]
...
plt.savefig('Legion-Replica7.pdf', format='pdf', dpi=300, bbox_inches='tight')
