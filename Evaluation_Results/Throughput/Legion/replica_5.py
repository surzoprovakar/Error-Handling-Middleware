...
# Throughput (ops/sec)
hue_throughput = [115.14, 103.58, 101.01, 81.17, 67.9]
mvr_throughput = [141.67, 136.35, 126.67, 112.19, 109.6]
stateRoll_throughput = [126.78, 108.93, 91.67, 79.98, 58.36]
...
plt.savefig('Legion-Replica5.pdf', format='pdf', dpi=300, bbox_inches='tight')
