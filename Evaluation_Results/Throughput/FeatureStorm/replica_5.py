...
# Throughput (ops/sec)
hue_throughput = [176.49, 169.232, 155.58, 144.13, 134.41]
mvr_throughput = [201.14, 193.24, 186.14, 176.39, 169.84]
stateRoll_throughput = [186.14, 163.97, 158.06, 128.96, 113.34]
...
plt.savefig('FeatureStorm-Replica5.pdf', format='pdf', dpi=300, bbox_inches='tight')
