...
hue = [6392.5, 6867.833333, 7762, 9229.166667, 10149.33333]
mvr_undo = [5797.166667, 6381, 7260.35, 8660.666667, 9392]
stateRoll = [5999, 6486.833333, 7664.5, 9698.166667, 11327.5]
...
plt.savefig('Legion-Latency.pdf', format='pdf', dpi=300, bbox_inches='tight')
